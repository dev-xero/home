...
In this blog post we'll mostly focus on the **tokenizer**, and in part 2 we'll write the actual parser. So, even if you don't like Rust (like @anu lol), you can always reproduce this in your favorite programming language (bonus points if you choose C).
