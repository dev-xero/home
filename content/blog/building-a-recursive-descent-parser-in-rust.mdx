...
7. [Context-Free Grammar (CFGs)](#context-free-grammar)
...
# [Context-Free Grammar (CFGs)](#context-free-grammar)
...
CFGs can get rather complex, if you're interested in learning more I strongly recommend you check out the [wiki.](https://en.wikipedia.org/wiki/Context-free_grammar)
