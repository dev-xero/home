...
I started playing chess more frequently again, there's actually a lot of
...
(system design, ui, frontend + backend with real time and deployment) in a week
while juggling a plethora of other things. I love a good challenge, so it should
be pretty fun. ¯\\ \_(ツ)_ /¯
...
features of the game should have:
...
<RoundedImage
src="https://res.cloudinary.com/dnkbrrrld/image/upload/v1728223922/ui-design_mbgr5v.png"
alt="UI"
context="I'm currently tackling UI design."
/>

I think it's coming out nicely, just a little tweaks here and there and I can
finally get to writing code!
